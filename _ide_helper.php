 ...
 * Generated for Laravel 5.7.19 on 2018-12-22 08:27:50.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \IDEALE\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \IDEALE\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \IDEALE\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \IDEALE\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \IDEALE\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \IDEALE\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \IDEALE\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \IDEALE\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \IDEALE\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \IDEALE\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth {
         ...
         *
         * @return \IDEALE\Models\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \IDEALE\Models\User|false 
         * @static 
         */ 
...
namespace IDEALE\Tenant { 
    ...
    class TenantFacade {
        ...
        {
            return \IDEALE\Tenant\TenantManager::getTenant();
        }
        ...
        {
            return \IDEALE\Tenant\TenantManager::setTenant($tenant);
        }
...
namespace  { 
    ...
    class Tenant extends \IDEALE\Tenant\TenantFacade {}
